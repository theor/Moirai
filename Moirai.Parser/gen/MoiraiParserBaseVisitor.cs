...
public partial class MoiraiParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IMoiraiParserVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="MoiraiParser.when_tag"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitWhen_tag([NotNull] MoiraiParser.When_tagContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitTag_definition([NotNull] MoiraiParser.Tag_definitionContext context) { return VisitChildren(context); }
	/// <summary>
