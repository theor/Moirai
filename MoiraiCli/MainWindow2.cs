...
public class MainWindow2 : Window
{
    ...
    {
        foreach (var v in this.Subviews.OfType<ProgressDemo>())
        {
            v?.StopBtnClick();
        }
    ...
    class ProgressDemo : FrameView
    {
        ...
        internal System.Action PulseBtnClick = null;
        internal System.Action StartBtnClick;
        internal System.Action StopBtnClick;
        ...
        internal ProgressDemo(ustring title) : base(title)
        {
            ...
            Height = 2 + _verticalSpace + Dim.Height(startButton) + _verticalSpace + Dim.Height(ActivityProgressBar) + _verticalSpace +
                     Dim.Height(PulseProgressBar) + _verticalSpace;
        }
        ...
        {
            get { return _startedLabel.Text == "Started"; }
